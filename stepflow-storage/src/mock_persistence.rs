...
impl QueueStorage for DummyPersistence {
    ...
    async fn get_task_by_run_state(&self, _run_id: &str, _state_name: &str) -> Result<Option<StoredQueueTask>, StorageError> { unimplemented!() }
    async fn update_task_by_run_state(&self, _run_id: &str, _state_name: &str, _expected_status: Option<&str>, _changes: &UpdateStoredQueueTask) -> Result<u64, StorageError> { unimplemented!() }
}
// #[async_trait]
